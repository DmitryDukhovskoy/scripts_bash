...
icc=0
for sname in BeringS DenmarkS IclShtl ShtlScot LaManch NAtl39 BaffNAFram AlaskaIcld Fram79s2 DavisS2
...
# Capture the job id:
  job1id=$(sbatch -q batch -t 1:00:00 --nodes=1 -A fv3-cpu ${subpy} | cut -d " " -f4)
